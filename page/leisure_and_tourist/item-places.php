...
/*if(isset($data['go_path']))
{
   ...
   // $item = $db->getResult();
   // $db->getResultNull();
    $db->select('item_rest','*','id='.(int)$_GET['id'].'');
    $res = $db->getResult();
    $go=1;
        ...
        <div class="lat_services-content">
          <div class="lat_services-places-header"><?php echo '<img src="'.$res[url_img].'">'; ?>
            <div class="description">
              <p>Адресс: <?php echo $res[address] ; ?> </p>
          ...
          <!--<form method="post" action="">
            <button name="go_path" type="submit" value="Проложить" class="lat_services-button">Проложить маршрут</button>
          </form>-->
            <button id="go" class="lat_services-button">Проложить маршрут</button>
